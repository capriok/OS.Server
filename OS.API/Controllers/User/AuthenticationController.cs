...
namespace OS.API.Controllers.User
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(IConfiguration config, IUserManager userManager, ITokenService tokenService, ILogger<AuthenticationController> log)
        {
            _config = config;
        ...
        public ActionResult<AuthResponse> RefreshAuthentication()
        {
            ...
            _log.LogInformation($"(Token) Refreshing Authorization for : {usernameCookie}");
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        public ActionResult RevokeAuthentication([FromBody] UserModel user)
        {
            Request.Cookies.TryGetValue(_config["Cookie:Username"], out var usernameCookie);
